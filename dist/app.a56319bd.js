...
const validateAnswerFromUser = ()=>{
    colorElements.forEach((colorElement)=>{
        ...
        } else if (checkboxState && currentBackgroundValue !== drawnColorText) colorElement.setAttribute('disabled', '');
    });
};
submitAnswerButton.addEventListener('click', validateAnswerFromUser);

},{"color":"gW2oi"}],"gW2oi":[function(require,module,exports) {
...
},{"./conversions":"C4O54"}]},["7Nluk","bAabt"], "bAabt", "parcelRequireb743")

//# sourceMappingURL=app.a56319bd.js.map
